...
const t: TranslationMap = {
  ...
  // Step 1
  "step1.subtitle": { nl: "Kies het domein waarin je AI-assistent specialist wordt.", en: "Choose the domain your AI assistant will specialize in." },
  ...
  "step1.customPlaceholder": { nl: "Bijv. 'e-commerce productbeschrijvingen'", en: "E.g. 'e-commerce product descriptions'" },
  "step1.info": {
  ...
  // Step 2
  "step2.subtitle": { nl: "Definieer wie je assistent is en hoe die denkt.", en: "Define who your assistant is and how it thinks." },
  "step2.jobTitle": { nl: "Functietitel + senioriteitsniveau", en: "Job title + seniority level" },
  "step2.jobTitlePlaceholder": { nl: "Bijv. 'Senior Email Marketing Strategist met 10 jaar ervaring in B2B SaaS'", en: "E.g. 'Senior Email Marketing Strategist with 10 years of B2B SaaS experience'" },
  "step2.jobTitleTip": { nl: "Wees specifiek. 'Copywriter' is te breed. 'Senior conversion copywriter gespecialiseerd in SaaS onboarding flows' is beter.", en: "Be specific. 'Copywriter' is too broad. 'Senior conversion copywriter specialized in SaaS onboarding flows' is better." },
  "step2.mentalLens": { nl: "Mentale lens — hoe denkt de assistent?", en: "Mental lens — how does the assistant think?" },
  ...
  "step2.successPlaceholder": { nl: "Wanneer heeft de assistent goed werk geleverd? Bijv. 'als de output direct bruikbaar is zonder grote aanpassingen'", en: "When has the assistant done good work? E.g. 'when the output is directly usable without major adjustments'" },

  // Step 3
  "step3.subtitle": { nl: "Geef je assistent een filosofie. Zonder overtuiging klinkt het als een zoekmachine.", en: "Give your assistant a philosophy. Without conviction it sounds like a search engine." },
  "step3.belief": { nl: "Centrale overtuiging in één assertieve zin", en: "Central belief in one assertive sentence" },
  "step3.beliefPlaceholder": { nl: "Bijv. 'Elk stuk copy moet eerst scanbaar zijn, dan overtuigend.'", en: "E.g. 'Every piece of copy must be scannable first, then persuasive.'" },
  ...
  "step3.anchor": { nl: "Kwaliteitsanker — referentiepersoon of merk", en: "Quality anchor — reference person or brand" },
  "step3.anchorPlaceholder": { nl: "Bijv. 'Schrijf als Joanna Wiebe van Copyhackers' of 'De toon van Coolblue'", en: "E.g. 'Write like Joanna Wiebe from Copyhackers' or 'The tone of Mailchimp'" },
  "step3.info": {
  ...
  "step4.doPlaceholder": { nl: "Beschrijf hoe de assistent WEL moet klinken…", en: "Describe how the assistant SHOULD sound…" },
  "step4.dontPlaceholder": { nl: "Beschrijf hoe de assistent NIET mag klinken…", en: "Describe how the assistant should NOT sound…" },
  "step4.tip": {
  ...
  // Step 5
  "step5.subtitle": { nl: "Vertel je assistent voor wie en waar het werkt.", en: "Tell your assistant who it works for and where." },
  "step5.audience": { nl: "Doelgroep", en: "Target audience" },
  "step5.audiencePlaceholder": { nl: "Beschrijf je ideale lezer/klant zo specifiek mogelijk…", en: "Describe your ideal reader/customer as specifically as possible…" },
  ...
  "step5.brandPromisePlaceholder": { nl: "Wat beloof je je klanten? In één of twee zinnen.", en: "What do you promise your customers? In one or two sentences." },

  // Step 6
  "step6.subtitle": { nl: "Dit is de stap die de meeste builders overslaan.", en: "This is the step most builders skip." },
  "step6.checklist": { nl: "Interne checklist (max. 5 criteria)", en: "Internal checklist (max. 5 criteria)" },
  "step6.checklistPlaceholder": { nl: "Typ een criterium en druk Enter…", en: "Type a criterion and press Enter…" },
  ...
  "step6.mistakesPlaceholder": { nl: "Welke fouten maken gebruikers vaak bij het briefen? Bijv. 'te vage doelgroepomschrijving'", en: "What mistakes do users commonly make when briefing? E.g. 'too vague target audience description'" },
  "step6.info": {
  ...
  "step7.alwaysDoPlaceholder": { nl: "Bijv. 'Begin altijd met de belangrijkste boodschap'", en: "E.g. 'Always start with the most important message'" },
  "step7.neverDo": { nl: "Nooit doen", en: "Never do" },
  "step7.neverDoPlaceholder": { nl: "Bijv. 'Gebruik nooit jargon zonder uitleg'", en: "E.g. 'Never use jargon without explanation'" },
  "step7.outOfScope": { nl: "Reactie bij out-of-scope vragen", en: "Out-of-scope response" },
  "step7.outOfScopePlaceholder": { nl: "Wat moet de assistent zeggen als iemand iets vraagt buiten zijn expertise?", en: "What should the assistant say when asked something outside its expertise?" },
  "step7.missingInfo": { nl: "Protocol bij ontbrekende informatie", en: "Missing info protocol" },
  "step7.missingInfoPlaceholder": { nl: "Wat moet de assistent doen als de briefing onvolledig is?", en: "What should the assistant do when the briefing is incomplete?" },

  // Step 8
  "step8.subtitle": { nl: "De finishing touch: geef je assistent een identiteit.", en: "The finishing touch: give your assistant an identity." },
  ...
  "step8.descriptionPlaceholder": { nl: "Bijv. 'Een senior email copywriter die conversiegerichte flows schrijft'", en: "E.g. 'A senior email copywriter who creates conversion-focused flows'" },
  "step8.outputStructure": { nl: "Standaard outputstructuur", en: "Default output structure" },
  "step8.outputStructurePlaceholder": { nl: "Bijv. 'Onderwerpregel → Preview tekst → Body → CTA'", en: "E.g. 'Subject line → Preview text → Body → CTA'" },
  "step8.lengthLimits": { nl: "Lengtelimieten", en: "Length limits" },
  "step8.lengthLimitsPlaceholder": { nl: "Bijv. 'Max 150 woorden voor email, max 280 tekens voor social'", en: "E.g. 'Max 150 words for email, max 280 characters for social'" },
  ...
  "step8.kickoffSub": { nl: "Het eerste bericht dat de assistent stuurt wanneer geopend.", en: "The first message the assistant sends when opened." },
  ...
  "output.metadata": { nl: "Metadata", en: "Metadata" },
