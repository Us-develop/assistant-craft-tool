...
export default function Step5Context() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-semibold mb-1">{tr("step5.title", lang)}</h2>
        <p className="text-muted-foreground">{tr("step5.subtitle", lang)}</p>
      </div>

      <div>
        <label className="block text-sm font-medium mb-2">{tr("step5.audience", lang)}</label>
        <textarea
      ...
      <div>
        <label className="block text-sm font-medium mb-2">{tr("step5.channels", lang)}</label>
        <PillSelector
      ...
      <div>
        <label className="block text-sm font-medium mb-2">{tr("step5.brandPromise", lang)}</label>
        <textarea
